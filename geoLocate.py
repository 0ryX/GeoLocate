...
"""
In the first part of the function we try to install the library pygeoip
from the MaxMind database by calling on pip. Yourself with pip install pygeoip.
pastebin for source code is pastebin.com/RTyBxDQs
geoip library located at maxmind.com
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='IP Geoloaction Tool')
